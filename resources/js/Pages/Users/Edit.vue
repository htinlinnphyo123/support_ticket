...
const form = useForm({
    ...
    organisation_id: props.user.organisation_id ? String(props.user.organisation_id) : '',
});
...
orgOptions.unshift({ value: '', name: 'Select Organisation (Optional)' });
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <!-- Password -->
                            <div>
                                <FwbInput v-model="form.password" type="password" label="Password (Leave blank to keep current)" :validation-status="form.errors.password ? 'error' : ''" />
                            ...
                            <div class="flex items-center gap-4">
                                <FwbButton type="submit" :disabled="form.processing">Save Changes</FwbButton>
                            </div>
                        </form>
                    </div>
                </div>
